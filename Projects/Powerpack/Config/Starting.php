...
[
    ...
    //--------------------------------------------------------------------------------------------------
    // Extract View Data -> 5.3.9
    //--------------------------------------------------------------------------------------------------
    //
    // Bu ayar true ayarlanırsa başlangıç kontrolcüsünden gönderilen datalar kontrolcüler üzerinde
    // de kullanılabilir olur. View::send('Send Data') gibi gönderilen bir data viewde $send olarak
    // olarak kullanılırken controllerde $this->send olarak kullanılabilir.
    //
    //--------------------------------------------------------------------------------------------------
